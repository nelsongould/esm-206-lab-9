...
homes_sub <- homes %>%
  filter(City == "Arroyo Grande" | City == "San Luis Obispo" | City == "Santa Maria-Orcutt" | City == "Atascadero")
...
# Note: THIS IS BAD (because PricePerSqFt is calculated from the dependen variable Price --- biased overfitting of model results) --- Look for COLINEARITY
